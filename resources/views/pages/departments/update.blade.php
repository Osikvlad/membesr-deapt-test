    ...
    <div class="mt-5 text-center">
        <div class="container">
            ...
            <div class="mt-3">
                ...
                <form class="text-left" method="post" action="{{route('departments.update', $department->id)}}">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Название отдела</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Название отдела"
